...
export function getAnimationStyles(): string {
  ...
  /* In the light theme, --code-bg matches --surface (both #e8e8e2) so kbd
     chips disappear into the .hint-banner background. Use the page bg for
     contrast plus a slightly darker border. */
