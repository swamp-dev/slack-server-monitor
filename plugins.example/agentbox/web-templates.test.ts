...
beforeEach(() => {
  ...
  // T10 added the progress columns; createSchema() defines the original
  // shape, so we re-run the plugin's in-place migration to bring an
  // already-created table up to the current production schema.
