...
import { migrateRunsTable } from '../../plugins.example/agentbox.js';
import {
  loadDashboardData,
  renderDashboard,
  renderQueue,
  ...
  DASHBOARD_CLIENT_JS,
  type QueueIssue,
} from '../../plugins.example/agentbox/web-templates.js';
...
export async function startE2EServer(): Promise<void> {
  ...
  // plugins.example/agentbox/web.ts (lines ~395–545) without invoking
